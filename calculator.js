...
var editconstraints = function(func, old) {
    ...
    stroke(0, 0, 0);
    strokeWeight(2);
    line(width/2-(min(width, height) -200)/2, height/2-(min(width, height) -200)/2.5, width/2-(min(width, height) -200)/2+(min(width, height)-200)/2.5, width/2-(min(width, height) -200)/2.5);
    textAlign(LEFT, BASELINE);
    textSize(15*min(width,height)/600);
    text("Minimum x-value:", width/2-(min(width, height) -200)/3, 150+(min(width, height)-200)/4);
    text("Maximum x-value:", width/2-(min(width, height) -200)/3, 150+(min(width, height)-200)/4);
