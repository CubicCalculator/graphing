...
var editconstraints = function(func, old) {
    ...
    constraintedit(wh+socm/7.7, ht+socm/3.9, str(func.constraints[0][0]), "startX", func, [0, 0]);
    ...
    if (func.constraints.length === 2) {
        ...
        constraintedit(wh+socm/7.7, ht+socm/1.45, str(func.constraints[1][0]), "startY", func, [1, 0]);
        ...
        constraintedit(wh+socm/7.7, ht+socm/2.1, str(func.constraints[1][0]), "startY", func, [1, 0]);
        ...
        constraintedit(wh+socm/7.7, ht+socm/1.42, str(func.constraints[2][0]), "startZ", func, [2, 0]);
