...
var editconstraints = function(func, old) {
    ...
    stroke(0, 0, 0);
    strokeWeight(2);
    line(width/2-(min(width, height) -200)/2, height/2-(min(width, height) -200)/2.5, width/2-(min(width, height) -200)/2-min(width, height)-200/2.5, width/2-(min(width, height) -200)/2+min(width,height)-200);
    textAlign(LEFT, BASELINE);
